/*Задача 1
       a) Необходимо создать интерфейс Swimmable (Плавающий).
       В нем должен быть один метода swim (плыть).
       b) Создайте несколько классов, реализующих этот интерфейс
       (Duck (утка), Boat(лодка), Person (человек).
