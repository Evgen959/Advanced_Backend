/*
    ...
    Все методы, реализованные в задаче переписать как имплементацию интерфейса AccountPredicate
*/
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("------Д/З-----PredicateAccountsWithMoreTHanGivenLimit----------");
        printAccounts(filterAccounts(accounts, new PredicateAccountsWithMoreTHanGivenLimit(1500)));


        System.out.println();
        System.out.println("------------getAccountsByOwner------------");
        printAccounts(getAccountsByOwner(accounts, new Person("Bob", 23)));
        System.out.println("------Д/З--------PredicateAccountsByOwner--------------");
        printAccounts(filterAccounts(accounts, new PredicateAccountsByOwner(new Person("Bob", 23))));

        System.out.println();
        System.out.println("----------getAccountsByYear-----------");
        printAccounts(getAccountsByOpenYear(accounts, 2024));
        System.out.println("------Д/З--------PredicateAccountsByYear--------------");
        printAccounts(filterAccounts(accounts, new PredicateAccountsByYear(2024)));
        ...
        System.out.println("--------------PredicateAccountsByAge-----------------");
